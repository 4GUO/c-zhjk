...
<div class='index_block home2'>
	...
	<div class='content'>
		...
		<div class='home2_2'>
			<div class='home2_2_1'>
				<div nctype='item_image' class='item syw'> <img nctype='imagea' src='<?php echo $item_data['rectangle1_image'];?>' alt=''>
					<?php if($item_edit_flag) { ?>
					...
					<a href='javascript:;' nc_type='dialog' dialog_title='编辑模型版块布局D' dialog_id='image_publish' dialog_width='580' uri='<?=_url('mb_special_do/image_publish', array('image' => encrypt($item_data['rectangle1_image']), 'type' => $item_data['rectangle1_type'], 'data' => encrypt($item_data['rectangle1_data']), 'size' => '320*130', 'imgbox' => 'syw', 'item_type' => 'home4'))?>'><i class='icon-edit'></i>编辑</a>
					<?php } ?>
				</div>
				<div class='home2_2_2'>
					<div nctype='item_image' class='item'> <img nctype='imagea' src='<?php echo $item_data['rectangle2_image'];?>' alt=''>
						...
						<a href='javascript:;' nc_type='dialog' dialog_title='编辑模型版块布局D' dialog_id='image_publish' dialog_width='580' uri='<?=_url('mb_special_do/image_publish', array('image' => encrypt($item_data['rectangle2_image']), 'type' => $item_data['rectangle2_type'], 'data' => encrypt($item_data['rectangle2_data']), 'size' => '320*130', 'imgbox' => 'home2_2_2', 'item_type' => 'home4'))?>'><i class='icon-edit'></i>编辑</a>
						<?php } ?>
					</div>
				</div>
			</div>
		...
		<div class='home2_1'>
			<div nctype='item_image' class='item'> <img nctype='imagea' src='<?php echo $item_data['square_image'];?>' alt=''>
				...
				<a href='javascript:;' nc_type='dialog' dialog_title='编辑模型版块布局D' dialog_id='image_publish' dialog_width='580' uri='<?=_url('mb_special_do/image_publish', array('image' => encrypt($item_data['square_image']), 'type' => $item_data['square_type'], 'data' => encrypt($item_data['square_data']), 'size' => '320*260', 'imgbox' => 'home2_1', 'item_type' => 'home4'))?>'><i class='icon-edit'></i>编辑</a>
				<?php } ?>
			</div>
		</div>
	</div>
