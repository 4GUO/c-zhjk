...
<form method='get' action='<?=users_url('tihuoquan/send_log')?>'>
...
<table class='css-default-table' id='my_agent'>
	...
	<tbody>
		...
		<tr>
			...
			<td width='70' height='90'><?php if(!empty($output['member_list'][$val['lg_member_id']]['headimg'])) {?><img src='<?php echo $output['member_list'][$val['lg_member_id']]['headimg'];?>' width='60' style='width: 60px; border-radius: 50%' /><?php }?></td>
			<td style='text-align: left; width: 200px;'>
				<p class='member_info'><span>姓名：</span><?php if(!empty($output['member_list'][$val['lg_member_id']]['nickname'])) {?><?php echo $output['member_list'][$val['lg_member_id']]['nickname'];?><?php }?></p>
