...
<div class='eject_con'>
	...
	<form id='waybill_form' method='post' action='<?=_url('shop_waybill/edit')?>'>
	    <input type='hidden' name='form_submit' value='ok' />
		<input type='hidden' name='waybill_id' value='<?php echo $output['waybill_info']['waybill_id'];?>' />
		<dl>
			<dt><i class='required'>*</i>模板名称：</dt>
			<dd>
				<input class='text w150' type='text' name='waybill_name' id='waybill_name' value='<?php echo $output['waybill_info']['waybill_name'];?>' />
		...
		<dl>
			...
			<dd>
				<input type='text' value='<?php echo $output['waybill_info']['waybill_width'];?>' name='waybill_width' id='waybill_width' class='w60 text'>
		...
		<dl>
			...
			<dd>
				<input type='text' value='<?php echo $output['waybill_info']['waybill_height'];?>' name='waybill_height' id='waybill_height' class='w60 text'>
				<em class='add-on'>mm</em> <span></span>
		...
		<dl>
			...
			<dd>
				<input type='text' value='<?php echo $output['waybill_info']['waybill_top'];?>' name='waybill_top' id='waybill_top' class='w60 text'>
				<em class='add-on'>mm</em> <span></span>
		...
		<dl>
			...
			<dd>
				<input type='text' value='<?php echo $output['waybill_info']['waybill_left'];?>' name='waybill_left' id='waybill_left' class='w60 text'>
				<em class='add-on'>mm</em> <span></span>
			...
			<dd>
				<div class='css-goods-default-pic'>
					<div class='goodspic-uplaod'>
						<div class='upload-thumb'> <img nctype='waybill_image' src='<?=$output['waybill_info']['waybill_image']?>'> </div>
						<input name='waybill_image' nctype='waybill_image' value='<?=$output['waybill_info']['waybill_image']?>' type='hidden' />
						<span></span>
				...
				<ul class='css-form-radio-list'>
					<li>
						<label for='waybill_usable_1'>
							<input id='waybill_usable_1' type='radio' name='waybill_usable' value='1' <?php echo $output['waybill_info']['waybill_usable'] ? 'checked' : '';?>>
							是</label>
					</li>
					<li>
						<label for='waybill_usable_0'>
							<input id='waybill_usable_0' type='radio' name='waybill_usable' value='0' <?php echo $output['waybill_info']['waybill_usable'] ? '' : 'checked';?>>
							否</label>
					</li>
				</ul>
				<span></span>
				<p class='hint'>请首先设计模板然后再启用，启用后商家可以使用</p>
			</dd>
		</dl>
		<div class='bottom'>
