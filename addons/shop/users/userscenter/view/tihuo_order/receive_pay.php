...
<div class='item-publish'>
	<form method='post' id='form' action='<?=users_url('tihuo_order/receive_pay')?>'>
		...
		<div class='css-form-goods'>
			...
			<dl>
				<dt>支付单号：</dt>
				<dd>
					<?php echo isset($output['order_info']['pay_sn']) ? $output['order_info']['pay_sn'] : '';?>
				</dd>
			</dl>
			<dl>
				<dt>订单总金额：</dt>
				<dd>
					<?php echo isset($output['order_info']['total_pay']) ? $output['order_info']['total_pay'] : '';?>
				</dd>
			</dl>
			<dl>
				<dt>付款时间：</dt>
