...
<table class='css-default-table' id='my_agent'>
	...
	<tbody>
		...
		<tr class='bd-line'>
			...
			<td class='bdl' width='70' height='90'><?php if(!empty($output['member_list'][$val['buyer_id']]['headimg'])) {?><img src='<?php echo $output['member_list'][$val['buyer_id']]['headimg'];?>' width='60' style='width: 60px; border-radius: 50%' /><?php }?></td>
