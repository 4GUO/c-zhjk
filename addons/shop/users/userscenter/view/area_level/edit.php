...
<div class='item-publish'>
	...
	<form id='level_form' method='post' target='_parent' action='<?=users_url('area_level/edit')?>'>
		...
		<div class='css-form-goods'>
			...
			<dl>
				<dt>奖励：</dt>
				<dd>
					<input name='bonus_bili' value='<?=$output['level_info']['bonus_bili']?>' class='text w60' type='text'>&nbsp;%
					<span></span>
					<p class='hint'></p>
				</dd>
			</dl>
