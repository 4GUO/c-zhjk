...
<div class='eject_con'>
	...
	<form id='category_form' method='post' target='_parent' action='<?=users_url('attachment/add')?>'>
	    <input type='hidden' name='form_submit' value='ok' />
		<dl>
			<dt><i class='required'>*</i>分类名称：</dt>
			<dd>
				<input class='text w200' type='text' name='aclass_name' id='aclass_name' value='' />
			</dd>
		</dl>
		<dl>
			<dt><i class='required'>*</i>排序：</dt>
			<dd>
				<input class='text w60' type='text' name='aclass_sort' value='9999'  />
