...
<div class='css-form-default' style='margin-top: 20px;'>
	<div style='display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;'>
		...
		<div style='display: flex; gap: 10px; align-items: center;'>
			...
			<a href='<?=users_url('distribute_award/lingshou_fenhong_send', array('query_start_date' => input('query_start_date', ''), 'query_end_date' => input('query_end_date', ''), 'show_detail' => 0))?>' class='btn <?=$output['show_detail'] == 0 ? 'btn-blue' : 'btn-gray'?>' style='padding: 5px 15px; font-size: 12px;'>
				<i class='icon-bolt'></i> 快速模式
			</a>
			<a href='<?=users_url('distribute_award/lingshou_fenhong_send', array('query_start_date' => input('query_start_date', ''), 'query_end_date' => input('query_end_date', ''), 'show_detail' => 1))?>' class='btn <?=$output['show_detail'] == 1 ? 'btn-blue' : 'btn-gray'?>' style='padding: 5px 15px; font-size: 12px;'>
