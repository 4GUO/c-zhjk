...
<div class='eject_con'>
	...
	<form id='category_form' method='post' target='_parent' action='<?=users_url('turntable/add')?>'>
		...
		<dl>
			...
			<dd>
				<input class='text w200' type='text' name='percent' id='percent' value='' /><em class='add-on'><i>%</i></em>
		...
		<dl>
			...
			<dd>
				<input class='text w200' type='text' name='stock' id='stock' value='0' /></em>
				<p class='hint'></p>
			</dd>
		</dl>
		<dl>
			...
			<dd>
				<input class='text w200' type='text' name='reward_ratio' id='reward_ratio' value='0' /><em class='add-on'><i>%</i></em>
		...
		<dl>
			<dt>区块颜色：</dt>
			<dd>
				<input class='text w80' type='text' name='color' id='colorpicker' value='0' />
				<p class='hint'></p>
			</dd>
		</dl>
		<dl>
			...
			<dd>
				<div class='css-goods-default-pic'>
					<div class='goodspic-uplaod'>
						<div class='upload-thumb'> <img nctype='thumb' src='<?=STATIC_URL . '/images/default_image.png'?>'> </div>
						<input name='thumb' nctype='thumb' value='' type='hidden' />
						<span></span>
		...
		<dl>
			...
			<dd>
				<input class='text w60' type='text' name='sort' value='1'  />
...
$(function(){
    $('#category_form').validate({
        ...
        messages : {
            title : {
                required : '<i class=\'icon-exclamation-sign\'></i>奖项名称不能为空'
