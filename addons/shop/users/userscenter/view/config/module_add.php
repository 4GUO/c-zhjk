...
<div class='item-publish'>
	<form method='post' id='form' action='<?=users_url('config/module_add')?>'>
		<input name='form_submit' value='ok' type='hidden' />	
		<div class='css-form-goods'>
			<dl>
				<dt>名称：</dt>
				<dd>
					<input name='name' class='text w400' value='' type='text' />
					<span></span>
				</dd>
			</dl>
			<dl>
			...
			<dl>
				<dt>链接：</dt>
				<dd>
					<input nctype='link' name='link' class='text w400' value='' type='text' style='float:left;' />
			...
			<dl>
				<dt>排序：</dt>
				<dd>
					<input name='m_sort' class='text w400' value='' type='text' />
					<span></span>
