...
<form method='get' action='<?=users_url('dis_public/index')?>'>
	<table class='search-form'>	
		<tbody><tr>
			...
			<th style='padding:0px 15px;'>竖向级数</th>
			<td class='w160'><input class='text w60' name='miny' value='<?=input('miny', '')?>' type='text'>&nbsp;~&nbsp;<input class='text w60' name='maxy' value='<?=input('maxy', '')?>' type='text'></td>
			<th style='padding:0px 15px;'>横向位置</th>
			<td class='w160'><input class='text w60' name='minx' value='<?=input('minx', '')?>' type='text'>&nbsp;~&nbsp;<input class='text w60' name='maxx' value='<?=input('maxx', '')?>' type='text'></td>
			<td class='tc w70'>
