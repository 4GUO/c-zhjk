...
<form method='get' action='<?=users_url('pd_log/index')?>'>
...
<table class='css-default-table' id='my_agent'>
	...
	<tbody>
		...
		<tr>
			...
			<td width='70' height='90'><?php if(!empty($output['mapping_fans'][$val['lg_member_id']]['headimg'])) {?><img src='<?php echo $output['mapping_fans'][$val['lg_member_id']]['headimg'];?>' width='60' style='width: 60px; border-radius: 50%' /><?php }?></td>
			<td style='text-align: left; width: 200px;'>
				<p class='member_info'><span>昵称：</span><?php if(!empty($output['mapping_fans'][$val['lg_member_id']]['nickname'])) {?><?php echo $output['mapping_fans'][$val['lg_member_id']]['nickname'];?><?php }?></p>
				<p class='member_info'><span>姓名：</span><?php if(!empty($output['member_list'][$val['lg_member_id']]['truename'])) {?><?php echo $output['member_list'][$val['lg_member_id']]['truename'];?><?php }?></p>
				<p class='member_info'><span>手机号：</span><?php if(!empty($output['member_list'][$val['lg_member_id']]['mobile'])) {?><?php echo $output['member_list'][$val['lg_member_id']]['mobile'];?><?php }?></p>				
			</td>
