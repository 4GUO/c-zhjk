...
class shop_tihuoquan_cart extends base\model
{
    protected $tableName = 'fxy_shop_tihuoquan_cart';
    /**
     * 购物车商品总金额
     */
    ...
    public function add($goods_info, $quantity)
    {
        ...
        if (isset($goods_info['taocan_id'])) {
            $condition['taocan_id'] = $goods_info['taocan_id'];
        } else {
            $condition['taocan_id'] = 0;
        }
        if (isset($goods_info['tihuoquan_id'])) {
            $condition['tihuoquan_id'] = $goods_info['tihuoquan_id'];
        } else {
            $condition['tihuoquan_id'] = 0;
        }
        ...
        $array['taocan_id'] = isset($goods_info['taocan_id']) ? $goods_info['taocan_id'] : 0;
        $array['tihuoquan_id'] = isset($goods_info['tihuoquan_id']) ? $goods_info['tihuoquan_id'] : 0;
		//更改购物车总商品数和总金额
