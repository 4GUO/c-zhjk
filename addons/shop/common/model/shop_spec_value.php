...
namespace model;
use base;
class shop_spec_value extends base\model
{
    protected $tableName = 'fxy_shop_spec_value';
	public function getList($condition = array(), $field = '*', $order = 'sp_value_sort asc,sp_value_id asc', $page = null, $get_p = null){
		if($page && $get_p){
