...
class alipay
{
    ...
    public function submit($param)
    {
        ...
        $this->call_back_url = $param['call_back_url'];
    ...
    public function getReturnInfo($payment_config)
    {
        ...
        if ($verify) {
            return array('out_trade_no' => $_GET['out_trade_no'], 'trade_no' => $_GET['trade_no']);
        }
        return false;
    }
    /**
        ...
        if ($verify) {
            ...
            if (!empty($doc->getElementsByTagName('notify')->item(0)->nodeValue)) {
                ...
                if ($trade_status == 'TRADE_FINISHED' || $trade_status == 'TRADE_SUCCESS') {
                    return array('out_trade_no' => $out_trade_no, 'trade_no' => $trade_no);
                }
            }
        }
        return false;
