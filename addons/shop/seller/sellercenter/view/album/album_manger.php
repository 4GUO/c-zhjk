			...
			if (e.state == 200) {
				...
				if(list_data.length > 0){
					...
					$.each(list_data, function(i){
						v = list_data[i];
						$html += '<li><a href=\'JavaScript:void(0);\' onclick=\'replace_mobile_img(\'' + v['apic_cover'] + '\');\'><img src=\'' + v['apic_cover'] + '\' title=\'' + v['apic_name'] + '\'/></a><div class=\'move icon-pencil\' rel=\'' + v['apic_id'] + '\'></div><div class=\'delete icon-trash\' rel=\'' + v['apic_id'] + '\'></div></li>';
					})
					$html += '</ul>';
				}else{
		...
		getAjax(url, data, function(e) {
			if (e.state == 200) {
				...
				if(list_data.length > 0){
					...
					$.each(list_data, function(i){
						v = list_data[i];
						$html += '<li><a href=\'JavaScript:void(0);\' nctype=\'' + items + '\' img_url=\'' + v['apic_cover'] + '\' onclick=\'insert_img(this);\'><img src=\'' + v['apic_cover'] + '\' title=\'' + v['apic_name'] + '\'/></a><div class=\'move icon-pencil\' rel=\'' + v['apic_id'] + '\'></div><div class=\'delete icon-trash\' rel=\'' + v['apic_id'] + '\'></div></li>';
					})
					$html += '</ul>';
				}else{
					var $html = '<div class=\'warning-option\'><i class=\'icon-warning-sign\'></i><span>相册中暂无图片</span></div>';
