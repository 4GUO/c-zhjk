...
<div class='tabmenu'>
	<a href='javascript:void(0)' class='css-btn css-btn-green' nc_type='dialog' dialog_title='添加幻灯片' dialog_id='my_swiper_add' dialog_width='480' uri='<?=_url('swiper/add')?>'>新增幻灯片</a>
</div>
<form method='get' action='<?=_url('swiper/index')?>'>
	...
	<thead>
		...
		<tr>
			...
			<td colspan='20'>
				...
				<a href='javascript:void(0)' class='css-btn-mini' nc_type='batchbutton' uri='<?=_url('swiper/del')?>' name='id' confirm='确定删除?'><i class='icon-trash'></i>删除</a>
			</td>
		</tr>
		<?php } ?>
	</thead>
	<tbody>
		...
		<tr class='bd-line' nc_type='table_item' idvalue='<?=$val['id']?>' >
			...
			<td class='nscs-table-handle'>
			    <span>
				    <a href='javascript:void(0)' nc_type='dialog' dialog_width='480' dialog_title='编辑幻灯片' dialog_id='my_category_edit' uri='<?=_url('swiper/edit', array('id' => $val['id']))?>' class='btn-blue'><i class='icon-edit'></i>
				        <p>编辑</p>
				    </a>
				</span>
				<span>
				    <a href='javascript:void(0)' confirm='确定删除?' url='<?=_url('swiper/del', array('id' => $val['id']))?>' class='btn-red delete'><i class='icon-trash'></i>
				        <p>删除</p>
				    </a>
				</span>
			</td>
