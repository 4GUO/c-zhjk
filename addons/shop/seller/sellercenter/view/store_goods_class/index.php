...
<div class='tabmenu'>
	<a href='javascript:void(0)' class='css-btn css-btn-green' nc_type='dialog' dialog_title='添加商品分类' dialog_id='my_category_add' dialog_width='600' uri='<?=users_url('store_goods_class/add')?>'>新增分类</a>
</div>
	...
	<tbody>
		...
		<tr class='<?php echo !empty($val['child']) ? 'ld-line' : 'bd-line';?>' nc_type='table_item' idvalue='<?=$val['stc_id']?>' >
			...
			<td class='nscs-table-handle'>
			    <span>
				    <a href='javascript:void(0)' nc_type='dialog' dialog_width='600' dialog_title='编辑商品分类' dialog_id='my_category_edit' uri='<?=users_url('store_goods_class/edit', array('id' => $val['stc_id']))?>' class='btn-blue'><i class='icon-edit'></i>
				        <p>编辑</p>
				    </a>
				</span>
				<span>
		...
		<tr class='<?php echo $k == $child_count - 1 ? 'bd-line' : 'ld-line';?>' nc_type='table_item' idvalue='<?=$v['stc_id']?>' >
			...
			<td class='nscs-table-handle'>
			    <span>
				    <a href='javascript:void(0)' nc_type='dialog' dialog_width='600' dialog_title='编辑商品分类' dialog_id='my_category_edit' uri='<?=users_url('store_goods_class/edit', array('id' => $v['stc_id']))?>' class='btn-blue'><i class='icon-edit'></i>
				        <p>编辑</p>
				    </a>
				</span>
				<span>
