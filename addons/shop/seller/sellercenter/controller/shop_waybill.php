...
class shop_waybill extends control {
	...
	public function indexOp(){
		$list_temp = model('shop_waybill')->getList(array('store_id' => $this->store_id), '*', 'waybill_id desc');
	...
	public function editOp(){
		...
		if(chksubmit()){
			...
			$waybill_info = $model_waybill->getInfo(array('store_id' => $this->store_id, 'waybill_id' => $waybill_id));
